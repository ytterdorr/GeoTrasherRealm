...
import { View, ScrollView, Text, TouchableOpacity, SafeAreaView, StyleSheet, Alert, Title, Image } from "react-native";
...
class SessionButtonTop extends React.Component {
    constructor(props) {
        super(props);
        const itemList = [
            ...
            { name: 'metal', color: 'brown', value: 0, image: images.metal },
